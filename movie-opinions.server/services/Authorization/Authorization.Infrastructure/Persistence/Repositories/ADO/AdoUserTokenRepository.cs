...
namespace Authorization.Infrastructure.Persistence.Repositories.ADO
{
    public class AdoUserTokenRepository : RepositoryBase, IUserRefreshTokenRepository
    {
        ...
        public async Task<UserRefreshToken> DeleteAsync(Guid id)
        {
            return await ExecuteWithConnectionAsync(async (conn) =>
            {
                var sql = @"
        ...
        public async Task<IEnumerable<UserRefreshToken>> GetAllTokensUserAsync(Guid userId)
        {
        ...
        public async Task<UserRefreshToken?> GetUserTokenAsync(string refreshToken)
        {
            return await ExecuteWithConnectionAsync(async (conn) =>
            {
                var sql = @"
