...
namespace Authorization.Infrastructure.Persistence.Repositories.Dapper
{
    public class DapperUserTokenRepository : RepositoryBase, IUserRefreshTokenRepository
    {
        ...
        public Task<UserRefreshToken> CreateAsync(UserRefreshToken entity)
        {
            throw new NotImplementedException();
        }

        public Task<UserRefreshToken> DeleteAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<UserRefreshToken>> GetAllTokensUserAsync(Guid userId)
        {
            throw new NotImplementedException();
        }

        public Task<UserRefreshToken?> GetUserTokenAsync(string refreshToken)
        {
            throw new NotImplementedException();
        }

        public Task<UserRefreshToken> UpdateAsync(UserRefreshToken entity)
        {
            throw new NotImplementedException();
        }
    }
